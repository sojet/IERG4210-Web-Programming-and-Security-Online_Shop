...
<html>
    <head>
        <title>IERG4210 Supermarket Add Category</title>
    ...
    <body class="item-content" >
        ...
        <div class="top_heading">      
            <h1 class="top-heading">IERG4210 Supermarket Admin Panel -- Add Category</h1>
        </div>
    ...
    <fieldset>
            <legend class="label-text"> New Category</legend>
            ...
            enctype="multipart/form-data">
                ...
                <div> <input class="name-label label-text" id="name" type="text" name="name" required="required" /> </div>
