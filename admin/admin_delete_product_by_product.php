...
<html>
    <head>
        <title>IERG4210 Supermarket Delete Product by Pategory</title>
    ...
    <body class="item-content" >
        ...
        <div class="top_heading">      
            <h1 class="top-heading">IERG4210 Supermarket Admin Panel -- Delete Product by Product</h1>
        </div>
    ...
    <fieldset>
            <legend class="label-text"> Delete Product by Product</legend>
            <form id="prod_delete_by_prod_delete" method="POST" action="admin-process.php?action=prod_delete"
            enctype="multipart/form-data">
            <label class="label-text" for="pid"> Select Product*</label>
            <div> <select class="label-text" id="pid" name="pid"><?php echo $options; ?></select></div>
