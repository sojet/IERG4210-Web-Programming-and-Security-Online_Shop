...
<html>
    <head>
        <title>IERG4210 Supermarket Edit Category</title>
    ...
    <body class="item-content" >
        ...
        <div class="top_heading">      
            <h1 class="top-heading">IERG4210 Supermarket Admin Panel -- Edit Category</h1>
        </div>
    ...
    <fieldset>
            <legend class="label-text"> Edit Category</legend>
            <form id="cat_edit" method="POST" action="admin-process.php?action=cat_edit"
            enctype="multipart/form-data">
            <label class="label-text" for="catid"> Select Category *</label>
            <div> <select class="label-text" id="catid" name="name"><?php echo $options; ?></select></div>
                <label class="label-text" for="catid"> Category *</label>
                <div> <input class="label-text cat-label" id="catid" name="catid" content="catid"></input></div>
                <input class="image-button" type="submit" value="Edit"/>
