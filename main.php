        ...
        <div class="right">
            ...
            <?php
                ...
                {   
                    ...
                    echo '<p><a href="product.php?id='.$prod["pid"].'" class="product-name" id="product-name">';
                    echo $prod["name"];
                    echo '</a></p>' ;
                    echo '<p>';
                    echo'<h3 class="product-price" id="product-price">';
                    echo '$' .$prod["price"];
                    echo '</h3>';
                    echo '<button type="Add" 
                    class = "product-button"
                    id = $prod["name"]
                    onclick = "checkProduct('.$prod["pid"].')"
