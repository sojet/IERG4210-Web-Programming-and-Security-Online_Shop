...
<head>
    ...
    <body class="item-content" onload="shoppinglist_update()">
        ...
        <?php
            ...
            $res2 = ierg4210_prod_fetchOneProduct($_GET["id"]); 
            $products = '<ul>';
        ...
        <div class="right">            
            ...
            <?php
                ...
                {   
                    ...
                    echo '<li><a href ="category.php?id='.$prod["catid"].' ">Return to Category</a> --> </li>';
                    echo '<li><a href ="product.php?id='.$prod["pid"].' " >';
                    echo $prod["name"];
                    echo '</a></li>';
                    echo '</ul>';
                    echo '<ul>';
                    echo '<li>';
                    echo '<img alt="No Image" class="detail-image" src="../admin/lib/images/' . $prod["filename"] . '">';
                    echo '<p><h1>';
                    echo $prod["name"];
                    echo '</h1></p>' ;
                    echo '<p>';
                    echo'<h3 class="detail-price">';
                    echo '$' .$prod["price"];
                    echo '</h3>';
                    echo '<h3 class="detail-desciption">';
                    echo $prod["description"];
                    echo '</h3>';
                    echo '<button type="Add" class="detail-button"  id = $prod["name"] 
                    onclick = "checkProduct('.$prod["pid"].')">Add to cart</button></p>';
                    echo'</li>';
                    echo '</ul>';
                }
                echo '</ul>';
